...
class Trainer:
    ...
    def fit(
        ...
        trn_log_list, val_log_list, dev_log_list = self.progressor(**kwargs)
        ...
        return self.finalizer(**kwargs)

    def progressor(self, trn_loader, val_loader, dev_loader):
        trn_log_list = []
        val_log_list = []
        dev_log_list = []
        ...
        for epoch in range(self.num_epochs):
            ...
            trn_loss, val_loss = self.run_engine(**kwargs)

            # dev
            kwargs = dict(
                dev_loader=dev_loader,
            )
            dev_score = self.run_monitor(**kwargs)
    ...
    def finalizer(self, trn_log_list, val_log_list, dev_log_list):
    ...
    def run_engine(self, trn_loader, val_loader):
        kwargs = dict(
            trn_loader=trn_loader, 
            val_loader=val_loader, 
        )
    ...
    def run_monitor(self, dev_loader):
        kwargs = dict(
            dev_loader=dev_loader, 
        )
